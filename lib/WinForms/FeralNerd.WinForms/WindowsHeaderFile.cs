...
namespace FeralNerdLib.WinForms.Windows.h
{
    ...
    public static class WndProcUtils
    {
        public static int HiWord(int wParam)
        {
            return (int)(wParam & 0xFFFF0000) >> 16;
        }

        public static int HiWord(IntPtr wParam)
        {
            return (int)((long)wParam & 0xFFFF0000) >> 16;
        }
